...
int main ()
{
    ...
    myStory.addScene("CAM1",{
        SStory::ContentBody("Te adentras en el camino, la luna está especialmente brillante, cada detalle del suelo resalta.", SSound::Sample::wolf),
        ...
        }, SSound::Sample::howl_right)
    });
    myStory.addScene("CAM2",{
        SStory::ContentBody("A pesar de lo frondoso del bosque, puedes escuchar la naturaleza que habita el ajeno lugar. Una calma se apodera de tu cuerpo mientras continuas haciendo camino.", SSound::Sample::forest),
    ...
    myStory.addScene("CAM3",{
        SStory::ContentBody("Descendiendo por el camino, llegas al claro de un rio.", SSound::Sample::river),
    ...
    myStory.addScene("FINAL",{
        SStory::ContentBody("Cierras los ojos y duermes.", SSound::Sample::piano),
    ...
    myStory.addScene("WOLF",{
        SStory::ContentBody("Al acercarte, un nuevo aullido se escucha aun más cerca que antes, pero del lado opuesto, casi como si la criatura supiera que la estas buscando.", SSound::Sample::howl_left),
    ...
    myStory.addScene("HUNT",{
        ...
        SStory::ContentBody("Otro disparo, pero esta vez te deja sin alientos. Al revisarte, ves como la sangre empieza a fluir del pecho a travez de la ropa.", SSound::Sample::gun),
